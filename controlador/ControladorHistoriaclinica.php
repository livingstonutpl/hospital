		...
		function update(){
			if(isset($_POST) && !empty($_POST)){
				if(isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]){
					...
					$proximocontrol = Connection::sanitize($_POST["proximocontrol"]);
					...
					$tratamiento_his = Connection::sanitize($_POST["tratamiento_his"])." NOTA: su próximo control es: ".$proximocontrol;
