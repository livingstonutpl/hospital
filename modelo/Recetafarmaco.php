<?php
	...
	class Recetafarmaco{
		...
		public static function create($id_receta1, $id_farmaco1, $cantidad_recfar, $posologia_recfar, $duracion_recfar, $indicaciones_recfar){
			$sql = "INSERT INTO recetafarmaco (id_receta1, id_farmaco1, cantidad_recfar, posologia_recfar, duracion_recfar, indicaciones_recfar)
			VALUES ('$id_receta1', '$id_farmaco1', '$cantidad_recfar', '$posologia_recfar', '$duracion_recfar', '$indicaciones_recfar')";
		...
		public static function update($id_recetafarmaco, $id_receta1, $id_farmaco1, $cantidad_recfar, $posologia_recfar, $duracion_recfar, $indicaciones_recfar){
