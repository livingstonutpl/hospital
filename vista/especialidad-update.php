<?php
			...
			<section class="content">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title">Actualizar Especialidad</h3>
					</div>
					...
					<form action="#" class="form-horizontal" method="POST" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="nombre_esp" value="<?php echo $res->nombre_esp;?>" class="form-control" required autofocus>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="3" name="descripcion_esp" class="form-control" required><?php echo $res->descripcion_esp;?></textarea>
								</div>
							</div>
	...
	<?php
		...
		ControladorEspecialidad::update();
	?>
