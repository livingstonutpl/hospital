									...
									<select name="id_medico1" class="form-control select2" style="width: 100%;" required autofocus>
										...
										<?php
											...
											while ($dato2 = mysqli_fetch_object($res2)){ 
												...
												echo "<option ".$selected." value='".$dato2->id_medico."'>".$dato2->cedula_per." - ".$dato2->nombre_per." ".$dato2->apellido_per."</option>";
											}
										?>
									</select>
								</div>
									...
									<select name="id_especialidad1" class="form-control select2" style="width: 100%;" required>
										...
										<?php
											...
											while ($dato2 = mysqli_fetch_object($res2)){ 
												...
												echo "<option ".$selected." value='".$dato2->id_especialidad."'>".$dato2->nombre_esp."</option>";
											}
										?>
									</select>
								</div>
