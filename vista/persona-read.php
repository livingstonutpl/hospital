			...
			<section class="content">
				<div class="box box-primary">
					<div class="box-header with-border">
						<a href="persona-create.php" class="btn btn-primary"><i class="fas fa-plus"></i> Nuevo</a>
					</div>
						...
						<table id="myTable" class="display table table-bordered table-striped table-condensed table-hover" width="100%">
							...
							<tbody>
								...
								<?php
									...
									echo "<td>".$dato2->id_usuario." - ".$dato2->nombre_usu."</td>";
									}
									}
									
									// OPCIONES
									echo "<td>";
									echo "<a href='persona-update.php?id_persona=".$dato->id_persona."' title='Actualizar'><i class='fas fa-pen text-green'></i></a>&nbsp;&nbsp;";
									echo "<a href='persona-delete.php?id_persona=".$dato->id_persona."' title='Eliminar'><i class='fas fa-trash text-red'></i></a>";
									echo "</td>";
									echo "</tr>";
									}
									?>
