					...
					<form action="#" class="form-horizontal" method="POST" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="date" name="fecha_rec" value="<?php echo $res->fecha_rec;?>" class="form-control" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="time" name="hora_rec" value="<?php echo $res->hora_rec;?>" class="form-control" required>
								</div>
								</div>
